...
public class Canada {
    ...
    private String presumptiveCases;
    ...
    public String getPresumptiveCases() {
        return presumptiveCases;
    }

    public void setPresumptiveCases(String presumptiveCases) {
        this.presumptiveCases = presumptiveCases;
    }
